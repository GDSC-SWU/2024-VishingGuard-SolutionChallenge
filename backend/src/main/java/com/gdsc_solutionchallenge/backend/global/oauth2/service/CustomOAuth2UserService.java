package com.gdsc_solutionchallenge.backend.global.oauth2.service;
...
import com.gdsc_solutionchallenge.backend.global.oauth2.CustomOAuth2User;
import com.gdsc_solutionchallenge.backend.global.oauth2.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private User getUser(OAuthAttributes attributes, SocialType socialType) throws Exception {
        User findUser = userRepository.findBySocialType(socialType);
        if(findUser == null) {
