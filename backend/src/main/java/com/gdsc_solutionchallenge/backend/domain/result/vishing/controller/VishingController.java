package com.gdsc_solutionchallenge.backend.domain.result.vishing.controller;

import com.gdsc_solutionchallenge.backend.domain.result.vishing.dto.VishingReqDto;
import com.gdsc_solutionchallenge.backend.domain.result.vishing.service.VishingService;
